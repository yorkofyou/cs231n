...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss = bce_loss(logits_real, torch.ones(logits_real.shape[0]).type(dtype)) + bce_loss(logits_fake, torch.zeros(logits_real.shape[0]).type(dtype))
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    return loss
...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss = (1 / 2 * (scores_real - 1) ** 2 + 1 / 2 * scores_fake ** 2).mean()
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    return loss
