...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == "rnn":
            out, cache = rnn_forward(out, h0, Wx, Wh, b)
        elif self.cell_type == "lstm":
            out, cache = lstm_forward(out, h0, Wx, Wh, b)
        out, vocab_cache = temporal_affine_forward(out, W_vocab, b_vocab)
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(1, max_length):
            ...
            if self.cell_type == "rnn":
                h, _ = rnn_step_forward(out[:, i, :], h, Wx, Wh, b)
            elif self.cell_type == "lstm":
                h, prev_c, _ = lstm_step_forward(out[:, i, :], h, prev_c, Wx, Wh, b)
